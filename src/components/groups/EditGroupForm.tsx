...
import type { Group, GroupWithMemberInfo } from '@/types/groups'
...
interface EditGroupFormProps {
  group: Group | GroupWithMemberInfo
  onSuccess?: () => void
  onCancel?: () => void
}
...
export function EditGroupForm({ group, onSuccess, onCancel }: EditGroupFormProps) {
  ...
  const [coverImage, setCoverImage] = useState<string>(group.cover_image || '')
